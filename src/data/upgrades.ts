...
export const UPGRADES: Record<string, Upgrade[]> = {
  warrior: [
    ...
    { id: 'iron_skin', name: 'Iron Skin', description: 'Passively increases armour by 20', modifiers: { armour: 20 } },
    { id: 'battle_cry', name: 'Battle Cry', description: 'Increases strength by 10 during combat', modifiers: { strength: 10 } },
    { id: 'shield_mastery', name: 'Shield Mastery', description: 'Off-hand armour bonus doubled', modifiers: { armour: 15 } },
  ...
  mage: [
    ...
    { id: 'arcane_shield', name: 'Arcane Shield', description: 'Converts 10 intelligence to armour', modifiers: { armour: 12 } },
  ...
  paladin: [
    { id: 'divine_shield', name: 'Divine Shield', description: 'Temporary invulnerability once per fight', modifiers: { armour: 20 } },
    ...
    { id: 'aura_of_protection', name: 'Aura of Protection', description: 'Reduces incoming damage by 10%', modifiers: { armour: 18 } },
